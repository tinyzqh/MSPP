...
def main():
    ...
    # all_txt_path = instantiation.get_all_txt_filename(root_path="/home/hzq/Master's_thesis/Kagebunsin-no-jyutu/results/cartpole-balance_final_seed_1_dreamer_kl_beta_1_action_repeat_2_explore_batch_size_51_gpu_true")
