...
class MPCPlanner(nn.Module):
	...
	def forward(self, belief, state):
		...
		for _ in range(self.optimisation_iters):
			...
			actions = (action_mean + action_std_dev * torch.randn(self.planning_horizon, B, self.candidates, self.action_size, device=action_mean.device)).view(self.planning_horizon, B * self.candidates,
